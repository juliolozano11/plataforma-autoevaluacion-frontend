...
export default function AdminDashboardPage() {
  ...
  const isLoading = sectionsLoading || questionnairesLoading || studentsLoading || evaluationsLoading;
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Bienvenido al panel de administración de la plataforma de autoevaluación
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900">{stats.sections}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">Cuestionarios</p>
                  <p className="text-2xl font-semibold text-gray-900">{stats.questionnaires}</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900">{stats.evaluations}</p>
                </div>
              </div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Evaluaciones en progreso:</span>
                  <span className="font-medium">
